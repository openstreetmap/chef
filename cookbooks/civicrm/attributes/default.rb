default[:civicrm][:version] = "4.7.16"
...
default[:civicrm][:extensions][:cividiscount][:revision] = "3.3"
...
default[:civicrm][:extensions][:osm][:revision] = "1.2"
...
default[:civicrm][:extensions][:civirules][:revision] = "1.11"
...
default[:civicrm][:extensions][:stripe][:revision] = "4.7.1"
...
default[:civicrm][:extensions][:mailchimp][:revision] = "v2.0"
