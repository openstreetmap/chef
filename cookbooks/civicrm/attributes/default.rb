default[:civicrm][:version] = "4.6.20"
...
default[:civicrm][:extensions][:cividiscount][:revision] = "3.2"
...
default[:civicrm][:extensions][:civirules][:revision] = "1.2"
...
default[:civicrm][:extensions][:mailchimp][:revision] = "v1.8.6"
