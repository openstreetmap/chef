...
if platform?("debian")
  ...
  if Chef::VERSION == "18.8.11"
    edit_resource(:file, "/etc/apt/keyrings/mcp.gpg") do
  ...
  if node[:dmi][:system][:product_name].end_with?("Gen9")
    ...
    # Workaround v18.8.11 bug: https://github.com/chef/chef/issues/15214
    if Chef::VERSION == "18.8.11"
      edit_resource(:file, "/etc/apt/keyrings/mcp-gen9.gpg") do
        action :create_if_missing
      end
    end
  ...
  if node[:dmi][:system][:product_name].end_with?("Gen10")
    ...
    # Workaround v18.8.11 bug: https://github.com/chef/chef/issues/15214
    if Chef::VERSION == "18.8.11"
      edit_resource(:file, "/etc/apt/keyrings/mcp-jammy.gpg") do
        action :create_if_missing
      end
    end
    ...
    # Workaround v18.8.11 bug: https://github.com/chef/chef/issues/15214
    if Chef::VERSION == "18.8.11"
      edit_resource(:file, "/etc/apt/keyrings/mcp-focal-gen10.gpg") do
        action :create_if_missing
      end
    end
  else
    ...
    # Workaround v18.8.11 bug: https://github.com/chef/chef/issues/15214
    if Chef::VERSION == "18.8.11"
      edit_resource(:file, "/etc/apt/keyrings/mcp-bionic-gen9.gpg") do
        action :create_if_missing
      end
    end
  end
